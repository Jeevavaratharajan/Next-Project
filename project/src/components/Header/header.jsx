...
import { useState } from "react";
 ...
 const Header = () => {
  ...
  return (
    <>
      <div className=" w-full flex flex-row h-[60px] sm:h-[70px] lg:h-[75px] bg-[#0f3963] relative ">
        ...
        <div className=" hidden sm:flex sm:w-4/7  sm:flex-row sm:justify-center sm:items-center pr-5  ">
          <div className="w-1/4 flex justify-center items-center"> <h2 className=" text-xl text-white hover:cursor-pointer hover:underline hover:decoration-white">Home</h2> </div>
          <div className="w-1/4 flex justify-center items-center"> <h2 className=" text-xl text-white hover:cursor-pointer hover:underline hover:decoration-white">About</h2> </div>
