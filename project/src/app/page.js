            ...
            <div className="px-4 lg:px-28">
              <div className="grid grid-cols-12 mb-8 sm:mb-12">
                <div className="col-span-12 lg:col-span-8 lg:col-start-3 lg:px-14 text-center">
                  <h2 className="text-[22px] md:text-[45px] text-[#0f3963] leading-none font-bold ">Explore The Rental Types</h2>
                </div>
              </div>
        ...
        <section className=" py-14 hidden sm:block bg-white  text-zinc-900 ">
            <div className="px-4 lg:px-28">
              <div className="grid grid-cols-12 mb-12">
                <div className="col-span-12 lg:col-span-8 lg:col-start-3 lg:px-14 text-center">
                  <h2 className="text-[22px] md:text-[45px] text-[#0f3963] leading-none font-bold mb-6">Discover Your Dream House Today</h2>
                </div>
              </div>
        ...
        <section className=" sm:py-14 py-8 bg-blue-50  text-zinc-900 ">
            <div className="px-4 lg:px-12">
              <div className="grid grid-cols-12 mb-6">
                <div className="col-span-12 lg:col-span-8 lg:col-start-3 lg:px-14 text-center">
                  <h2 className="text-[22px] md:text-[45px] text-[#0f3963] leading-none font-bold">Testimonials</h2>
                </div>
              </div>
