...
const Properties = () => {
  ...
  return (
    <>
      <div
        className="h-[auto] m-3 sm:m-6 rounded-t-[15px] sm:rounded-t-[20px] shadow-4xl"
                  ...
                  >
                    <Link href={`/propertyDetail/${product._id}`}>
                      <div className="h-full w-full flex flex-row gap-1 max-[400px]:flex-col ">
                        {/* Image Section */}
                        <div
                          className="w-[310px] sm:w-[300px] shadow-md max-[400px]:w-full h-auto"
                          style={{
                        ...
                        {/* Text Section */}
                        <div className="w-[360px] sm:w-[400px] flex flex-col justify-between text-[14px] text-gray-700 border-[1px] border-[#063970] rounded-lg p-3 overflow-hidden bg-gradient-to-br from-white via-blue-50 to-white max-[400px]:w-full max-[400px]:text-[12px] max-[400px]:p-2">
                          {/* Property Name */}
                          <div className="flex">
